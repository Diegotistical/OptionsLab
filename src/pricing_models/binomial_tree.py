...
class BinomialTree:
    ...
    def _validate_inputs(
        ...
        ot_enum = (
            OptionType.CALL.value if option_type == "call" else OptionType.PUT.value
        )
        es_enum = (
            ExerciseStyle.EUROPEAN.value
            if exercise_style == "european"
            else ExerciseStyle.AMERICAN.value
        )
    ...
    def price(
        ...
        price, _, _ = _solve_binomial_tree(S, K, T, r, sigma, q, self.num_steps, ot, es)
        return price
    ...
    def calculate_all(
        ...
        price, delta, gamma = _solve_binomial_tree(
