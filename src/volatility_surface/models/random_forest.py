...
class RandomForestVolatilityModel(VolatilityModelBase[RandomForestRegressor]):
    ...
    def _save_model_impl(self, model_path: str, scaler_path: str) -> None:
        with self._lock:
            ...
            logger.info(f"RandomForest model saved to {model_path} and scaler saved to {scaler_path}")
    ...
    def _load_model_impl(self, model_path: str, scaler_path: str) -> None:
        with self._lock:
            ...
            self.trained = True
            logger.info(f"RandomForest model loaded from {model_path} and scaler loaded from {scaler_path}")
