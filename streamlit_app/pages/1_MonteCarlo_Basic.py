...
with col1:
    ...
    S = st.number_input("Spot Price (S)", min_value=0.01, value=100.0, step=1.0, key="spot")
    K = st.number_input("Strike Price (K)", min_value=0.01, value=100.0, step=1.0, key="strike")
    T = st.number_input("Time to Maturity (T, years)", min_value=0.01, value=1.0, step=0.01, key="time")
...
with col2:
    ...
    r = st.number_input("Risk-Free Rate (r)", min_value=0.0, value=0.05, step=0.01, format="%.4f", key="rate")
    sigma = st.number_input("Volatility (σ)", min_value=0.01, value=0.2, step=0.01, format="%.4f", key="vol")
...
with col3:
    ...
    num_sim = st.slider("Number of Simulations", min_value=1000, max_value=200000, value=50000, step=5000, key="sim")
    num_steps = st.slider("Steps per Path", min_value=10, max_value=500, value=100, step=10, key="steps")
