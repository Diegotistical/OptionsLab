...
class TestReproducibility:
    ...
    def test_per_trial_seeding(self):
        ...
        assert seed1_trial0 != seed1_trial1, "Different trials should get different seeds"
...
class TestSearchSpace:
    ...
    def test_lightgbm_search_space_suggest(self):
        ...
        study.optimize(objective, n_trials=5, show_progress_bar=False, catch=(Exception,))
